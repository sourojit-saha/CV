...
def triangulate(C1, pts1, C2, pts2):
    ...
    for i in range(pts1.shape[0]):
        ...
        err2 = pts2[i,:]-X2.T
        # print(err1, err2)
        total_err = err1@err1.T + err2@err2.T
        err = np.vstack((err, total_err))
...
def findM2(F, pts1, pts2, intrinsics, filename = 'q3_3.npz'):
    ...
    ***
    ...
    for i in range(M2s.shape[2]):
        ...
        print(i, err)
        # print(M2)
        # print(np.linalg.det(M2[:,0:3]))
        if err < best_err and np.all(P[:,2]>=0):
            print(i)
            best_err = err
            best_M2 = M2
            best_C2 = C2
...
if __name__ == "__main__":
    ...
    np.savez("q3_3.npz", F2=M2, C2=C2, P=P) 
