...
'''
def ransacF(pts1, pts2, M, nIters=200, tol=100):
...
def rodriguesResidual(K1, M1, p1, K2, p2, x):
    ...
    p1_projected = p1_projected[:,0:2]
    p2_projected = p2_projected[:,0:2]

    residuals = np.concatenate([(p1-p1_projected).reshape([-1]),(p2-p2_projected).reshape([-1])])
...
if __name__ == "__main__":
    ...
    M2, P, obj_start, obj_end = bundleAdjustment(K1, M1, p1, K2, M2, p2, P_init)
